	...
	if (!adjusttime)
	{
		if (!justCheck)
		{
			if (hitdata.blobID == 0)
			{
				...
				{
					int hitcount = 10;
					if (this.get_f32("COFFEE POWER") < 10){
						hitcount = this.get_f32("COFFEE POWER");
					}
			...
			else
			{
				...
				if (b !is null)
				{
					SendHitCommand(this, b, (b.getPosition() + this.getPosition()) * 0.5f, attackVel, hit_damage*this.get_f32("COFFEE POWER"));
				}
			}
		}
		return;
