...
void onDie(CBlob@ this)
{
	...
	for(int i = 0; i < 3; i++){
		...
		if (mina !is null)
		{
				...
				mina.Init();
				mina.set_u16("clone", this.get_u16("clone") - 1);
				mina.IgnoreCollisionWhileOverlapped(this);
				mina.server_setTeamNum(this.getTeamNum());
				mina.setPosition(this.getPosition());
				Vec2f vec = Vec2f((XORRandom(11) - 5) + this.getVelocity().x, (XORRandom(11) - 5) + this.getVelocity().y);
				mina.setVelocity(vec);
		}
	}
